...
# FROM: testcases\test_putawayRule\list_putawayRule.yml
from httprunner import HttpRunner, Config, Step, RunRequest


class TestCaseListPutawayrule(HttpRunner):

    config = Config("testcase description").verify(False)

    teststeps = [
        Step(
            RunRequest("/api/asura/wms/web/plc/putaway/rule/list")
            .post(
                "http://test.asura-wms.ruigushop.com/api/asura/wms/web/plc/putaway/rule/list"
            )
            .with_headers(
                **{
...
if __name__ == "__main__":
    TestCaseListPutawayrule().test_start()
